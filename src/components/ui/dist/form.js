...
var FormLabel = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(label_1.Label, __assign({ ref: ref, className: utils_1.cn(className), htmlFor: formItemId }, props)));
});
...
var FormMessage = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("p", __assign({ ref: ref, id: formMessageId, className: utils_1.cn("text-xs font-regular text-destructive", className) }, props), body));
});
