...
var NavigationMenu = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(NavigationMenuPrimitive.Root, __assign({ ref: ref, className: utils_1.cn("relative z-10", className) }, props),
        children,
...
var NavigationMenuList = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(NavigationMenuPrimitive.List, __assign({ ref: ref, className: utils_1.cn("group", className) }, props)));
});
exports.NavigationMenuList = NavigationMenuList;
NavigationMenuList.displayName = NavigationMenuPrimitive.List.displayName;
var NavigationMenuItem = NavigationMenuPrimitive.Item;
exports.NavigationMenuItem = NavigationMenuItem;
var navigationMenuTriggerStyle = class_variance_authority_1.cva("group inline-flex h-10 w-full rounded-md bg-background px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50");
